  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-primary-foreground hover:scale-105 transform transition-bounce shadow-elevation",
        ocean: "bg-gradient-ocean text-accent-foreground hover:bg-accent/90 shadow-button",
        sunset: "bg-gradient-sunset text-warning-foreground hover:opacity-90 shadow-button",
        travel: "bg-primary text-primary-foreground hover:bg-primary-dark shadow-button border-2 border-primary-light/20",
      },
      size: {
